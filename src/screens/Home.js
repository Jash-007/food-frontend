...
export default function Home() {
  ...
  const loadFoodItems = async () => {
    let response = await fetch("https://food-backend-tjsa.onrender.com/api/auth/foodData");
 ...
 async function searchHandler() {
    ...
    const response = await fetch(`https://food-backend-tjsa.onrender.com/api/auth/searchfoodData/${search?search: "all"}`);
